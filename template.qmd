...
To the best of your ability, fill out the following sections: "What is it", "How do you use it?", "When are they useful?", "Challenges", and "Biological example" based on the corresponding Lightning Talk. If you're unfamiliar with markdown (the markup language for text in Quarto documents), see [Markdown Basics](https://quarto.org/docs/authoring/markdown-basics.html) or ask one of us for help.
